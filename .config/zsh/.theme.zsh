...
typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VICMD_FOREGROUND=4
typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VIVIS}_FOREGROUND=6
typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_FOREGROUND=4
typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VIVIS}_FOREGROUND=6
